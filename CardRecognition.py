...
# erstelle ein Convolutional Neural Network
# mit zwei möglichen Ausgaben 'magic-karte' oder 'etwas anderes'
...
if __name__ == "__main__":
    ...
    if "-train" in sys.argv:
        train, labels, labelClasses = loadData(
            filepath="E:/Python/Bachelor/data_CardDetection/train"
        )
